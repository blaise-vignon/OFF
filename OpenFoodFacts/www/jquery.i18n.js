...
( function ( $ ) {
	...
	I18N.prototype = {
		...
		init: function () {
			...
			String.prototype.toLocaleString = function () {
			    ...
			    //alert(this + " " + i18n.options.messageLocationResolver);
				value = this.valueOf();
				locale = i18n.locale;				
				fallbackIndex = 0;
				while ( locale ) {
					...
					do {
					    ...
					    //console.log(value + " " + locale + " " + locale.toLowerCase() + " " + _locale);
					    //alert(value + " " + locale + " " + locale.toLowerCase() + " " + _locale);
					    //alert(this + " " + i18n.options.messageLocationResolver);
				    ...
				    //if (value == "msg_login") alert("tolocalestring " + value);
					if ( locale === 'en' ) {
						break;
					}
		...
		*/
		parse: function (key, parameters) {
		    ...
		    //alert("in function, key: " + key + " param: " + parameters + " message: " + message);
			// FIXME: This changes the state of the I18N object,
			// should probably not change the 'this.parser' but just
			// pass it to the parser.
			this.parser.language = $.i18n.languages[$.i18n().locale] || $.i18n.languages['default'];
			if (message === '') {
			    //alert("this means trouble");
				message = key;
			}
	...
	*/
	$.i18n = function ( key, param1 ) {
		...
		//alert("main branch  " + key + "  " + param1);

		//if (typeof key === 'undefined') key = message;
	    if (typeof key === 'string') {
			...
			//alert("tvb  " + i18n.parse( key, parameters ));
